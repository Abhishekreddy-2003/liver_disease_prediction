...
class Util:
    def __init__(self, file_path = 'indian_liver_patient.csv'):
        self.features = ['Age', 
                         'Gender', 
                         'Total_Bilirubin', 
                         'Direct_Bilirubin',
    ...
    def page_footer(self):
        footer="""<style>
                ...
                </style><div class="footer"><p>Developed by <a style='display: block; text-align: center;' target="_blank">Abhishek Reddy Final Project</a></p></div>
                """
